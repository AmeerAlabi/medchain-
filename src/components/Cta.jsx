    ...
    <div className="flex justify-center items-center w-full bg-[#F4F7FA] h-auto py-10 md:py-20">
      <div className="p-[50px] flex flex-col justify-center items-center w-full max-w-[850px]  bg-white rounded-[15px] shadow-lg">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-[20px] gap-[15px] w-full">
          <button className=" cursor-not-allowed w-full md:w-[180px] h-[48px] rounded-[5px] bg-[#6833FB] text-white flex justify-center items-center  text-[14px] font-[400] transition duration-300 hover:bg-[#5b29d1]">
            Get started now
          </button>
          <button className=" cursor-not-allowed w-full md:w-[180px] h-[48px] rounded-[5px] border-[#6833FB] text-[#6833FB] flex justify-center items-center border-[2px] text-[14px] font-[400] transition duration-300 hover:bg-[#6833FB] hover:text-white">
            Download app
          </button>
        </div>
      </div>
